#!/bin/bash
STOREPASS="forgotten"
for ENT in serverAgvManager_J clientTwin_J clienBackoffice_J; do
...
for ENT in clientTwin_J clienBackoffice_J ; do
 echo "yes"|keytool -import -alias ${ENT} -keystore serverAgvManager_J.jks -file ${ENT}.pem -storepass ${STOREPASS}
 echo "yes"|keytool -import -alias server_J -keystore ${ENT}.jks -file serverAgvManager_J.pem -storepass ${STOREPASS}
done
echo "############################################################################"
